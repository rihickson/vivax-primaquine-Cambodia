...
if __name__ == '__main__':
    ...
    np.random.seed(100) #consistency of results
    ...
    run_post_processing(flag_all_prevalences = True, flag_resort_data = False, flag_make_plots = True, flag_elimination_comparison = True)
