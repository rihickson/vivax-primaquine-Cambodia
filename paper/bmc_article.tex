...
=======
\textit{Plasmodium vivax} (\pv) is the cause of a significant burden of malaria globally, with an estimated 7.5 (5.9, 9.3) million cases in 2018~\cite{who_2019}. In Cambodia, it has been responsible for 30--80\% of cases in different Provinces, with the proportion increasing as the burden of \textit{Plasmodium falciparum} (\pf) has decreased~\cite{Pengby}.
>>>>>>> 827ab60... starting to update background
...
The aggregated data used for model calibration are provided in Additional file~\ref{supp}, and on GitHub at \url{https://github.com/rihickson/vivax-primaquine-Cambodia}. \todo[inline]{Make this repo public.} 
