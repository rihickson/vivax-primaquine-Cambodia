...
\item Entirely a deterministic model, so the possibility of stochastic fadeout has been ignored.
...
\pv~is not likely to be eliminated by the target date of 2025 in Cambodia using PQ for Males 15 years and older in addition to current interventions. However, it is likely to have a substantial impact, both on detectable cases and those with hypnozoite reservoirs. 
